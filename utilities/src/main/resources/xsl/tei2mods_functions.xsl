	...
	<xsl:template name="lang">
		<xsl:call-template name="tokenizeLangs">
			<xsl:with-param name="src">
				<xsl:value-of select="/TEI/teiHeader/fileDesc/sourceDesc/msDesc/msContents/textLang/@mainLang"/>
			</xsl:with-param>
		</xsl:call-template>
	</xsl:template>
	<xsl:template name="physicalDescription">
		<mods:physicalDescription>
			...
			<mods:form type="material">
				<xsl:value-of select="/TEI/teiHeader/fileDesc/sourceDesc/msDesc/physDesc/objectDesc/supportDesc/support/material"/>
			</mods:form>
			<mods:internetMediaType>jp2</mods:internetMediaType>
			<mods:extent>
				<xsl:value-of select="count(//surface)"/>
				<xsl:for-each select="/TEI/teiHeader/fileDesc/sourceDesc/msDesc/physDesc/objectDesc/supportDesc/support/dimensions">,<xsl:value-of select="./height"/> x<xsl:value-of select="./width"/>
				</xsl:for-each>
			</mods:extent>
