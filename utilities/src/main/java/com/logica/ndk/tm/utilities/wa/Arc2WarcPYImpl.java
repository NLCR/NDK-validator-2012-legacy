 ...
 * @author Rudolf Daco
 */
public class Arc2WarcPYImpl extends AbstractUtility {

  public String execute(String arcFile, String targetDir) throws WAException {
    log.info("arcFile: " + arcFile);
    log.info("targetDir: " + targetDir);
    try {
      File file = new File(arcFile);
      if (!file.exists()) {
        throw new WAException("Arc file doesn't exist: " + arcFile);
      }
      ...
      String warcFileName = file.getName() + "." + WARC_EXT;
      String cmd = PYTHON_HOME + " " + getScriptPath(ARC2WARC_SCRIPT) + " -o " + targetDir + File.separator + warcFileName + " " + arcFile;
