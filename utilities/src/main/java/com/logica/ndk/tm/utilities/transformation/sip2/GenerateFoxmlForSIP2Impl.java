 ...
 * @author ondrusekl
 */
public class GenerateFoxmlForSIP2Impl extends GenerateFoxmlHelper {
  ...
  public String execute(final String cdmId, final Boolean dPublic, String locality) throws SystemException {
    ...
    for (org.dom4j.Node node : physicalMapDivs) {
      ...
      fileName= "K4".equals(cdm.getCdmProperties(cdmId).getProperty("importType"))?fileName.substring(USERCOPY_PREFIX.length()):fileName.substring(UC_PREFIX.length());
  ...
  public static void main(String[] args) {
    String cdmId = "1953dd10-2bbc-11e4-af4e-0050568209d4";
