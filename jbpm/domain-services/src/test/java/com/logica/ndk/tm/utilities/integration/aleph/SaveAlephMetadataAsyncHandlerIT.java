...
import com.logica.ndk.tm.jbpm.handler.file.CreateEmptyCdmAsyncHandler;
...
public class SaveAlephMetadataAsyncHandlerIT extends HandlerTestHelper {
  ...
  public void test() {
    ...
    HandlerTestHelper.execute(new SaveAlephMetadataAsyncHandler(), wi, wim, 5000);
  }
