...
import com.logica.ndk.tm.utilities.transformation.CreateCdmFromSkenAsyncHandler;

public class CreateCdmFromSkenAsyncHandlerIT extends HandlerTestHelper {
  ...
  public void test() {
    ...
    HandlerTestHelper.execute(new CreateCdmFromSkenAsyncHandler(), wi, wim, 5000);
  }
