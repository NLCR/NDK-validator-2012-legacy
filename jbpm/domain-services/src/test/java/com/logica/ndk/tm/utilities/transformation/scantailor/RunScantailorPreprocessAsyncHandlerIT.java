 ...
 * @author rudi
 */
public class RunScantailorPreprocessAsyncHandlerIT extends HandlerTestHelper {
  ...
  public void test() {
    ...
    HandlerTestHelper.execute(new RunScantailorPreprocessAsyncHandler(), wi, wim, 5000);
  }
