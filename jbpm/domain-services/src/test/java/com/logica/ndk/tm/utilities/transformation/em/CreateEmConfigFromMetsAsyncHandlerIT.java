...
public class CreateEmConfigFromMetsAsyncHandlerIT extends HandlerTestHelper {

  @Ignore
  public void test() {
    Map<String, Object> params = new HashMap<String, Object>();
    params.put("cdmId", "29aba5d0-cdc2-11e1-91a2-00505682629d");
    ...
    execute(new CreateEmConfigFromMetsAsyncHandler(), wi, wim, 10000);
  }
