...
public class AssignUrnNbnSyncHandlerIT extends HandlerTestHelper {
  ...
  public void test() {
    ...
    AssignUrnNbnSyncHandler handler = new AssignUrnNbnSyncHandler();
    handler.executeWorkItem(wi, wim);
  }
