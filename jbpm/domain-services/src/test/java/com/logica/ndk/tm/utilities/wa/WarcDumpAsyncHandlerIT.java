...
public class WarcDumpAsyncHandlerIT extends HandlerTestHelper {
  @Ignore
  public void test() {
    Map<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("source", "c:\\NDK\\data_test\\_wa\\warc\\new\\");
    parameters.put("target", "c:\\NDK\\data_test\\_wa\\warc\\new\\dump");
    parameters.put("doSolrIndex", "false");
    ...
    execute(new WarcDumpAsyncHandler(), wi, wim, 20000);
  }
}
