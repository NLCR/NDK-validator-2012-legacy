 ...
 * @author kovalcikm
 */
public class StartJBPMProcessSyncHandler extends AbstractSyncHandler {
  ...
  protected Map<String, Object> executeSyncWorkItem(WorkItem workItem, List<ParamUtility> paramUtility) throws Exception {
    ...
    final SyncCallInfo<StartJBPMProcess> sci = new SyncCallInfo<StartJBPMProcess>("startJBPMProcessEndpoint", StartJBPMProcess.class, paramUtility);
