...
import com.logica.ndk.tm.utilities.premis.TransformAMDMetsToPremis;

/**
 * @author brizat
 */
public class TransformAMDMetsToPremisAsyncHandler extends AbstractAsyncHandler {
  ...
  protected String executeAsyncWorkItem(final WorkItem workItem, final List<ParamUtility> paramUtility) throws Exception {
    ...
    final AsyncCallInfo<TransformAMDMetsToPremis> aci = new AsyncCallInfo<TransformAMDMetsToPremis>("transformAMDMetsToPremisEndpoint", TransformAMDMetsToPremis.class, paramUtility);
