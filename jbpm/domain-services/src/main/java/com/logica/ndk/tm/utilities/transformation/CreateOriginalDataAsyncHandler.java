 ...
 * @author kovalcikm
 */
public class CreateOriginalDataAsyncHandler extends AbstractAsyncHandler {
  ...
  protected String executeAsyncWorkItem(WorkItem workItem, List<ParamUtility> paramUtility)
    ...
    final AsyncCallInfo<CreateOriginalData> aci = new AsyncCallInfo<CreateOriginalData>(
        "createOriginalDataEndpoint", CreateOriginalData.class, paramUtility);
