...
import com.logica.ndk.tm.utilities.premis.GeneratePremisKrameriusImport;

public class GeneratePremisKrameriusImportAsyncHandler extends AbstractAsyncHandler {
  ...
  protected String executeAsyncWorkItem(final WorkItem workItem, final List<ParamUtility> paramUtility) throws Exception {
    ...
    final AsyncCallInfo<GeneratePremisKrameriusImport> aci = new AsyncCallInfo<GeneratePremisKrameriusImport>("generatePremisKrameriusImportEndpoint", GeneratePremisKrameriusImport.class, paramUtility);
