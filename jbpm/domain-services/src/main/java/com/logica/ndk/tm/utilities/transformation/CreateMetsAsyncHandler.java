...
public class CreateMetsAsyncHandler extends AbstractAsyncHandler {
	...
	protected String executeAsyncWorkItem(WorkItem workItem, List<ParamUtility> paramUtility)
		...
		final AsyncCallInfo<CreateMets> aci = new AsyncCallInfo<CreateMets>(
				"createMetsEndpoint", CreateMets.class, paramUtility);
