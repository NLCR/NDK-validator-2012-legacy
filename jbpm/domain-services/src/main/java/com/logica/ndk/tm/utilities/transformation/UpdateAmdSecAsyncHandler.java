 ...
 *
 */
public class UpdateAmdSecAsyncHandler extends AbstractAsyncHandler {
  @Override
  protected String executeAsyncWorkItem(WorkItem workItem, List<ParamUtility> paramUtility) throws Exception {
    ...
    final AsyncCallInfo<UpdateAmdSec> aci = new AsyncCallInfo<UpdateAmdSec>("updateAmdSecEndpoint", UpdateAmdSec.class, paramUtility);
