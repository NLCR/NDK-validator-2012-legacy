...
import com.logica.ndk.tm.utilities.ocr.MoveOcrFiles;

/**
 * @author kovalcikm
 */
public class MoveOcrFilesAsyncHandler extends AbstractAsyncHandler {
  ...
  public String executeAsyncWorkItem(WorkItem workItem, List<ParamUtility> paramUtility) throws Exception {
    ...
    final AsyncCallInfo<MoveOcrFiles> aci = new AsyncCallInfo<MoveOcrFiles>("moveOcrFilesEndpoint", MoveOcrFiles.class, paramUtility);
