 ...
 *
 */
public class CheckIfMetsExistsAsyncHandler extends AbstractAsyncHandler{
  ...
  protected String executeAsyncWorkItem(WorkItem workItem, List<ParamUtility> paramUtility)throws Exception {
    ...
    final AsyncCallInfo<CheckIfMetsExists> aci = new AsyncCallInfo<CheckIfMetsExists>("checkIfMetsExistsEndpoint", CheckIfMetsExists.class, paramUtility);
