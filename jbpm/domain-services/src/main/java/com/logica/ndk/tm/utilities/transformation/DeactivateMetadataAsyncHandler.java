 ...
 * @author kovalcikm
 */
public class DeactivateMetadataAsyncHandler extends AbstractAsyncHandler {
  ...
  protected String executeAsyncWorkItem(WorkItem workItem, List<ParamUtility> paramUtility)
    ...
    final AsyncCallInfo<DeactivateMetadata> aci = new AsyncCallInfo<DeactivateMetadata>(
        "deactivateMetadataEndpoint", DeactivateMetadata.class, paramUtility);
