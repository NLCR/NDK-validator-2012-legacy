...
import com.logica.ndk.tm.utilities.transformation.jpeg2000.TransformJpeg2000;

/**
 * @author rudi
 */
public class TransformJpeg2000AsyncHandler extends AbstractAsyncHandler {
  ...
  public String executeAsyncWorkItem(WorkItem workItem, List<ParamUtility> paramUtility) throws Exception {
    ...
    final AsyncCallInfo<TransformJpeg2000> aci = new AsyncCallInfo<TransformJpeg2000>("transformJpeg2000Endpoint", TransformJpeg2000.class, paramUtility);
