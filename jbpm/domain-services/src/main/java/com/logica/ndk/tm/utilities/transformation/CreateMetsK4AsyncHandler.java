 ...
 *
 */
public class CreateMetsK4AsyncHandler extends AbstractAsyncHandler {
  @Override
  protected String executeAsyncWorkItem(WorkItem workItem, List<ParamUtility> paramUtility) throws Exception {
    ...
    final AsyncCallInfo<CreateMetsK4> aci = new AsyncCallInfo<CreateMetsK4>("createMetsK4Endpoint", CreateMetsK4.class, paramUtility);
