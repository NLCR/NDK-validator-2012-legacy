...
import com.logica.ndk.tm.utilities.fs.TransformToMixAnalyzer;

/**
 * @author kovalcikm
 *
 */
public class TransformToMixAnalyzerAsyncHandler extends AbstractAsyncHandler {
  ...
  public String executeAsyncWorkItem(WorkItem workItem, List<ParamUtility> paramUtility) throws Exception {
    ...
    final AsyncCallInfo<TransformToMixAnalyzer> aci = new AsyncCallInfo<TransformToMixAnalyzer>("transformToMixAnalyzerEndpoint", TransformToMixAnalyzer.class, paramUtility);
