 ...
 * @author ondrusekl
 */
public class CreateFlatStructureSyncHandler extends AbstractSyncHandler {
  ...
  protected Map<String, Object> executeSyncWorkItem(final WorkItem workItem, final List<ParamUtility> paramUtility) throws Exception {
    ...
    final SyncCallInfo<CreateFlatStructure> sci = new SyncCallInfo<CreateFlatStructure>("createFlatStructureEndpoint", CreateFlatStructure.class, paramUtility);
