 ...
 * @author majdaf
 */
public class HandleManualPostprocessAsyncHandler extends AbstractAsyncHandler {
  @Override
  public String executeAsyncWorkItem(WorkItem workItem, List<ParamUtility> paramUtility) throws Exception {
    ...
    final AsyncCallInfo<HandleManualPostprocess> aci = new AsyncCallInfo<HandleManualPostprocess>("handleManualPostprocessEndpoint", HandleManualPostprocess.class, paramUtility);
