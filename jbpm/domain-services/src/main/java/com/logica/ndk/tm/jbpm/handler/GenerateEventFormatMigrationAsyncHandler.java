...
import com.logica.ndk.tm.utilities.premis.GenerateEventFormatMigration;

/**
 * @author kovalcikm
 */
public class GenerateEventFormatMigrationAsyncHandler extends AbstractAsyncHandler {
  ...
  protected String executeAsyncWorkItem(final WorkItem workItem, final List<ParamUtility> paramUtility) throws Exception {
    ...
    final AsyncCallInfo<GenerateEventFormatMigration> aci = new AsyncCallInfo<GenerateEventFormatMigration>("generateEventFormatMigrationEndpoint", GenerateEventFormatMigration.class, paramUtility);
