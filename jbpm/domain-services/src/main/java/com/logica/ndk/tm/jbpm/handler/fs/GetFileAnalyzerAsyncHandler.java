...
import com.logica.ndk.tm.utilities.fs.GetFileAnalyzer;

/**
 * @author kovalcikm
 */
public class GetFileAnalyzerAsyncHandler extends AbstractAsyncHandler {
  ...
  public String executeAsyncWorkItem(WorkItem workItem, List<ParamUtility> paramUtility) throws Exception {
    ...
    final AsyncCallInfo<GetFileAnalyzer> aci = new AsyncCallInfo<GetFileAnalyzer>("getFileAnalyzerEndpoint", GetFileAnalyzer.class, paramUtility);
