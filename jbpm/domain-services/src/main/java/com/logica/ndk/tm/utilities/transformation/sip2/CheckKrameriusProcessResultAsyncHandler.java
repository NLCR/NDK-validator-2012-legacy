...
public class CheckKrameriusProcessResultAsyncHandler extends AbstractAsyncHandler{
  @Override
  public String executeAsyncWorkItem(WorkItem workItem, List<ParamUtility> paramUtility) throws Exception {
    ...
    final AsyncCallInfo<CheckKrameriusProcessResult> aci = new AsyncCallInfo<CheckKrameriusProcessResult>("checkKrameriusProcessResultEndpoint", CheckKrameriusProcessResult.class, paramUtility);
