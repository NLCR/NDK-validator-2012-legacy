 ...
 *
 */
public class CreateMetsMnsAsyncHandler extends AbstractAsyncHandler {
  ...
  protected String executeAsyncWorkItem(WorkItem workItem, List<ParamUtility> paramUtility)
    ...
    final AsyncCallInfo<CreateMetsMns> aci = new AsyncCallInfo<CreateMetsMns>(
        "createMetsMnsEndpoint", CreateMetsMns.class, paramUtility);
