 ...
 * @author londrusek
 */
public class CreateSIP1FromCDMAsyncHandler extends AbstractAsyncHandler {
  ...
  protected String executeAsyncWorkItem(WorkItem workItem, List<ParamUtility> paramUtility) throws Exception {
    ...
    final AsyncCallInfo<CreateSIP1FromCDM> aci = new AsyncCallInfo<CreateSIP1FromCDM>("createSIP1FromCDMEndpoint", CreateSIP1FromCDM.class, paramUtility);
