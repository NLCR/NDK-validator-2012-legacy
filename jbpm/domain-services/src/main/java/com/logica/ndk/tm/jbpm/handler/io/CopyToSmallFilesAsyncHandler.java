 ...
 * @author brizat
 */
public class CopyToSmallFilesAsyncHandler extends AbstractAsyncHandler {

  @Override
  public String executeAsyncWorkItem(WorkItem workItem, List<ParamUtility> paramUtility) throws Exception {
    log.info("CopyToSmallFiless handler started");
    ...
    aci.getClient().copySmallFilesAsync(source, target, wildcard);
