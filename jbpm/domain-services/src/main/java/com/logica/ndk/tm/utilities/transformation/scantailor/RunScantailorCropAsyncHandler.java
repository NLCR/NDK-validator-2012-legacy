 ...
 * @author rudi
 */
public class RunScantailorCropAsyncHandler extends AbstractAsyncHandler {
  ...
  public String executeAsyncWorkItem(WorkItem workItem, List<ParamUtility> paramUtility) throws Exception {
    ...
    final AsyncCallInfo<RunScantailorCrop> aci = new AsyncCallInfo<RunScantailorCrop>("runScantailorCropEndpoint", RunScantailorCrop.class, paramUtility);
