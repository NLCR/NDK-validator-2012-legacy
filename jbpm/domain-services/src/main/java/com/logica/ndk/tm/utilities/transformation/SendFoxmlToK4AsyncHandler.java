 ...
 * @author kovalcikm
 */
public class SendFoxmlToK4AsyncHandler extends AbstractAsyncHandler {
  ...
  protected String executeAsyncWorkItem(final WorkItem workItem, final List<ParamUtility> paramUtility) throws Exception {
    ...
    final AsyncCallInfo<SendFoxmlToK4> aci = new AsyncCallInfo<SendFoxmlToK4>("sendFoxmlToK4Endpoint", SendFoxmlToK4.class, paramUtility);
