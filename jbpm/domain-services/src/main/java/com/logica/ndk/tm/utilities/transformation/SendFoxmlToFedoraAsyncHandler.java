 ...
 * @author kovalcikm
 */
public class SendFoxmlToFedoraAsyncHandler extends AbstractAsyncHandler {
  ...
  protected String executeAsyncWorkItem(final WorkItem workItem, final List<ParamUtility> paramUtility) throws Exception {
    ...
    final AsyncCallInfo<SendFoxmlToFedora> aci = new AsyncCallInfo<SendFoxmlToFedora>("sendFoxmlToFedoraEndpoint", SendFoxmlToFedora.class, paramUtility);
