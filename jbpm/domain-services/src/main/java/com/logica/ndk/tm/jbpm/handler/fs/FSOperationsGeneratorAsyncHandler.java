 ...
 *
 */
public class FSOperationsGeneratorAsyncHandler extends AbstractAsyncHandler {
  ...
  public String executeAsyncWorkItem(WorkItem workItem, List<ParamUtility> paramUtility) throws Exception {
    ...
    final AsyncCallInfo<FSOperationsGenerator> aci = new AsyncCallInfo<FSOperationsGenerator>("fsOperationsGeneratorEndpoint", FSOperationsGenerator.class, paramUtility);
