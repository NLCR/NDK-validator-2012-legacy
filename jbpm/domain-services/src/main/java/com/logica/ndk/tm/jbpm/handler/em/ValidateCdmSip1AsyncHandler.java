...
import com.logica.ndk.tm.utilities.em.ValidateCdmSip1;

public class ValidateCdmSip1AsyncHandler extends AbstractAsyncHandler{  
  ...
  protected String executeAsyncWorkItem(WorkItem workItem, List<ParamUtility> paramUtility) throws Exception {
    ...
    final AsyncCallInfo<ValidateCdmSip1> aci = new AsyncCallInfo<ValidateCdmSip1>("validateCdmSip1Endpoint", ValidateCdmSip1.class, paramUtility);
