 ...
 * @author rudi
 */
public class CreateCdmFromSkenSyncHandler extends AbstractSyncHandler {
  ...
  public Map<String, Object> executeSyncWorkItem(WorkItem workItem, List<ParamUtility> paramUtility) throws Exception {
    ...
    final SyncCallInfo<CreateCdmFromSken> sci = new SyncCallInfo<CreateCdmFromSken>("createCdmFromSkenEndpoint", CreateCdmFromSken.class, paramUtility);
